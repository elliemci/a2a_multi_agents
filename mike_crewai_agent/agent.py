...
def generate_calendar() -> dict[str, list[str]]:
    ...
    print("---- Mike's Generated Calendar ----")
    print(calendar)
    print("---------------------------------")
    return calendar
...
class SchedulingAgent:
    ...
    def __init__(self):
        ...
        # there is no task in the Agent definition yet, it is dynamically created in invoke()
    ...
    def invoke(self, question: str) -> str:
        ...
        # tie agent, task and processes inside a crew
        crew = Crew(
